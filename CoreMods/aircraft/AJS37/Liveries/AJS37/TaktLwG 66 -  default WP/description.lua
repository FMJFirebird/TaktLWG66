livery = {
    ...
    --Diffuse  -----------------------------------
    {"LNS_VIG_EXT_FUS_T", 0 ,"../TaktLwG 66 -  default/LNS_VIG_FUSELAGE_T_WP",false};
    {"LNS_VIG_EXT_FUS_L", 0 ,"../TaktLwG 66 -  default/LNS_VIG_FUSELAGE_L",false};
    {"LNS_VIG_EXT_FUS_R", 0 ,"../TaktLwG 66 -  default/LNS_VIG_FUSELAGE_R",false};
    ...
    ---PILOT-----
    {"LNS_VIG_PILOT_COVERS", 0 ,"../TaktLwG 66 -  default/LNS_VIG_PILOT_COVERS",false};
